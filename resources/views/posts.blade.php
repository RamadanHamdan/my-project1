<x-layout>
    ...
    @forelse ($posts as $post )
                ...
                @empty
                <div>
                <p class="font-semibold text-xl my-4">No posts yet.</p>
                <a href="/posts" class="block text-blue-700 hover:underline" >&laquo;Back to all post</a>
                </div>
          @endforelse
     </div>  
   </div>
